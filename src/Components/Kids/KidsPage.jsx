...
import product2 from '../../assets/Lecotrus product-02.png';
import product3 from '../../assets/Lecotrus product-03.png';
...
const KidsPage = () => {
  ...
  const products = [
    { id: 2, image: product2, name: 'Master Blazer', price: 8000, color: 'blue', category: 'kids wear' },
    { id: 3, image: product3, name: 'Mistress Frock', price: 8500, color: 'yellow', category: 'kids wear' },
      ];
